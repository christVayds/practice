				...
				<form action="model/signin.inc.php" method="post" autocomplete="off">
					<div class="top">
						<div class="side one">
							...
							<input type="text" id="icourse" name="course" placeholder="Course" value="<?php if(isset($_GET['course'])){echo $_GET['course'];} ?>">
							<input type="text" id="ischoolID" name="schoolID" placeholder="School ID">
							<input type="number" id="iyear" name="year" placeholder="Year">
						</div>
						<div class="side two">
